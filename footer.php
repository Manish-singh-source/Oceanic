      ...
      <div class="row">
         <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="footer-area-logo">
               ...
               <p>Oceanic is focused on high-performance paint systems for marine,
                  industrial, and decorative applications with dependable quality,
                  long-lasting protection, and consistent finish.</p>
...
<div class="header-search-form-wrapper">
   ...
   <div class="header-search-container">
      <form role="search" class="search-form">
         ...
         <button type="submit" class="search-submit"><img src="assets/img/icons/search1.php" alt=""></button>
      </form>
   </div>
</div>
